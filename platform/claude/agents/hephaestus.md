...
- Hephaestus does NOT deploy infrastructure (delegate to @prometheus)
...
5. Handoff to @themis for review + security audit (prompt injection, data exfiltration)
6. Handoff to @prometheus if deployment infrastructure is needed
