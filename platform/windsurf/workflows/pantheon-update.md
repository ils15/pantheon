...
/pantheon-update --patch                  Force patch bump (3.17.1 → 3.17.2)
/pantheon-update --minor                  Force minor bump (3.17.1 → 3.18.0)
/pantheon-update --major                  Force major bump (3.17.1 → 4.0.0)
