 ...
 *   - Pantheon version badge (reads from meta.version)
 ...
 * runtime where @opentui/solid and @opencode-ai/plugin are installed.
 */
// @ts-nocheck
...
const plugin: TuiPluginModule & { id: string } = {
  ...
  tui: async (api, _options, meta) => {
    // meta.version comes from npm package version (or "dev" for local files)
