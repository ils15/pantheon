...
CODING_ELO = {
    "claude-opus-4-6": 1549, "claude-opus-4-7": 1498,
    "claude-sonnet-4-6": 1521, "claude-haiku-4-5": 1478,
    "gpt-5.4-high": 1484, "gpt-5.4-mini": 1440, "gpt-5.4-nano": 1350,
    "gpt-5-mini": 1420, "gpt-5-nano": 1300,
    "gemini-3.1-pro": 1454, "gemini-3-pro": 1437, "gemini-3-flash": 1436,
    "deepseek-v4-pro": 1502, "deepseek-v4-flash": 1432,
    "kimi-k2.6": 1460, "kimi-k2.5": 1430,
    "qwen3.6-plus": 1447,
    "minimax-m2.7": 1445, "minimax-m2.5": 1410, "minimax-m2.1-preview": 1399,
    "minimax-m2.5-free": 1350, "gpt-5-nano-free": 1300,
    "glm-5": 1445, "glm-4.7": 1439,
    "grok-4.20": 1471, "muse-spark": 1441,
}

SWE_BENCH = {
    "claude-opus-4-6": 80.8, "claude-opus-4-7": 79.5,
    "claude-sonnet-4-6": 78.5, "claude-haiku-4-5": 73.3,
    "gpt-5.4-high": 80.0, "gpt-5.4-mini": 74.5, "gpt-5.4-nano": 65.0,
    "gpt-5-mini": 73.0, "gpt-5-nano": 60.0,
    "gemini-3.1-pro": 80.6, "gemini-3-pro": 77.0, "gemini-3-flash": 74.0,
    "deepseek-v4-pro": 80.6, "deepseek-v4-flash": 79.0,
    "kimi-k2.6": 77.5, "kimi-k2.5": 76.0,
    "qwen3.6-plus": 75.0,
    "minimax-m2.7": 74.0, "minimax-m2.5": 72.0, "minimax-m2.5-free": 68.0,
    "minimax-m2.1-preview": 70.0,
    "glm-5": 75.5, "glm-4.7": 73.0,
    "grok-4.20": 76.0, "muse-spark": 74.5,
}

PRICING = {
    "claude-opus-4-6": (5.00, 25.00), "claude-opus-4-7": (15.00, 75.00),
    "claude-sonnet-4-6": (3.00, 15.00), "claude-haiku-4-5": (0.80, 5.00),
    "gpt-5.4-high": (12.50, 50.00), "gpt-5.4-mini": (0.50, 2.50), "gpt-5.4-nano": (0.05, 0.40),
    "gpt-5-mini": (0.40, 2.00), "gpt-5-nano": (0.05, 0.40),
    "gemini-3.1-pro": (4.00, 20.00), "gemini-3-pro": (2.00, 12.00), "gemini-3-flash": (0.50, 3.00),
    "deepseek-v4-pro": (1.74, 3.48), "deepseek-v4-flash": (0.14, 0.28),
    "kimi-k2.6": (1.50, 7.50), "kimi-k2.5": (0.50, 2.50),
    "qwen3.6-plus": (0.80, 4.00), "qwen3.6-plus-free": (0.00, 0.00),
    "minimax-m2.7": (0.30, 1.20), "minimax-m2.5": (0.20, 1.17), "minimax-m2.5-free": (0.00, 0.00),
    "minimax-m2.1-preview": (0.27, 0.95),
    "glm-5": (1.00, 3.20), "glm-4.7": (0.39, 1.75),
    "grok-4.20": (5.00, 15.00), "muse-spark": (0.95, 3.80),
}

LATENCY_MS = {
    "claude-opus-4-6": 1200, "claude-opus-4-7": 1500,
    "claude-sonnet-4-6": 800, "claude-haiku-4-5": 400,
    "gpt-5.4-high": 700, "gpt-5.4-mini": 500, "gpt-5.4-nano": 200,
    "gpt-5-mini": 450, "gpt-5-nano": 150,
    "gemini-3.1-pro": 650, "gemini-3-pro": 600, "gemini-3-flash": 300,
    "deepseek-v4-pro": 800, "deepseek-v4-flash": 350,
    "kimi-k2.6": 900, "kimi-k2.5": 700,
    "qwen3.6-plus": 600,
    "minimax-m2.7": 380, "minimax-m2.5": 400, "minimax-m2.5-free": 400,
    "glm-5": 500, "glm-4.7": 450,
    "grok-4.20": 600, "muse-spark": 550,
}
...
AGENT_TIERS = {
    "zeus":       {"tier": "premium", "type": "reasoning", "desc": "Orchestration, delegation",
                   "token_profile": "high-input", "why": "Long context, complex delegation"},
    "athena":     {"tier": "premium", "type": "reasoning", "desc": "Strategic planning, architecture",
                   "token_profile": "high-input", "why": "Deep analysis, long planning outputs"},
    "themis":     {"tier": "premium", "type": "reasoning", "desc": "Code review, security audit",
                   "token_profile": "high-input", "why": "Reviews entire files, deep reasoning"},

    "gaia":       {"tier": "default", "type": "analysis", "desc": "Remote sensing, LULC analysis",
                   "token_profile": "high-input", "why": "Analyzes large datasets"},
    "hephaestus": {"tier": "default", "type": "advanced", "desc": "AI pipelines, RAG, LangChain",
                   "token_profile": "high-output", "why": "Complex pipeline code"},
    "prometheus": {"tier": "default", "type": "advanced", "desc": "Infrastructure, Docker, CI/CD",
                   "token_profile": "medium-output", "why": "Complex configs, multi-stage builds"},
    "chiron":     {"tier": "default", "type": "advanced", "desc": "Model routing, provider config",
                   "token_profile": "medium-output", "why": "Routing decisions, provider analysis"},

    "hermes":     {"tier": "coding", "type": "coding", "desc": "Backend (FastAPI, Python, TDD)",
                   "token_profile": "high-output", "why": "Generates lots of code"},
    "aphrodite":  {"tier": "coding", "type": "coding", "desc": "Frontend (React, TypeScript)",
                   "token_profile": "high-output", "why": "JSX/TSX, CSS — lots of output"},
    "demeter":    {"tier": "coding", "type": "coding", "desc": "Database (SQLAlchemy, Alembic)",
                   "token_profile": "medium-output", "why": "Moderate code generation"},
    "echo":       {"tier": "coding", "type": "coding", "desc": "Conversational AI (Rasa NLU)",
                   "token_profile": "medium-output", "why": "Config + code generation"},

    "apollo":     {"tier": "fast", "type": "research", "desc": "Codebase discovery, research",
                   "token_profile": "many-calls", "why": "Many parallel searches"},
    "nyx":        {"tier": "fast", "type": "ops", "desc": "Observability, tracing, monitoring",
                   "token_profile": "many-calls", "why": "Frequent monitoring calls"},
    "iris":       {"tier": "fast", "type": "ops", "desc": "GitHub operations (PRs, issues)",
                   "token_profile": "many-calls", "why": "Many git/gh commands"},
    "mnemosyne":  {"tier": "fast", "type": "docs", "desc": "Memory bank, documentation",
                   "token_profile": "medium-output", "why": "Writes docs, moderate output"},
    "talos":      {"tier": "fast", "type": "hotfix", "desc": "Hotfixes, small bugs, CSS",
                   "token_profile": "low-output", "why": "Small fixes, minimal output"},
}
...
def strip_suffix(name: str) -> str:
    ...
    for suffix in ['-thinking', '-instant', '-high', '-codex', '-standard', '-medium', '-nano', '-mini', '-pro', '-flash', '-base']:
...
def get_model_score(model_id: str) -> dict:
    ...
    return {
        "elo": elo, "swe_bench": swe,
        "cost_input": price[0], "cost_output": price[1],
        "latency_ms": latency,
    }
...
def compute_cost(model_id: str, profile: str, calls: int = 1000) -> float:
    ...
    profiles = {"high-input": 2000, "high-output": 3000, "medium-output": 1500, "many-calls": 500, "low-output": 300}
...
def main():
    parser = argparse.ArgumentParser(description="Pantheon Model Routing — Deep Analysis")
