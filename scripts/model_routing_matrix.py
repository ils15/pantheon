...
AGENT_TIERS = {
    ...
    "zeus":       {"tier": "premium", "type": "reasoning",   "desc": "Orchestration, delegation, multi-agent coordination",
                   "token_profile": "high-input",  "why": "Long context, complex delegation logic"},
    "athena":     {"tier": "premium", "type": "reasoning",   "desc": "Strategic planning, architecture decisions, gap analysis",
                   "token_profile": "high-input",  "why": "Deep analysis of codebase, long planning outputs"},
    "themis":     {"tier": "premium", "type": "reasoning",   "desc": "Code review, security audit, OWASP Top 10, coverage validation",
                   "token_profile": "high-input",  "why": "Reviews entire files, needs deep reasoning for security"},
    ...
    "gaia":       {"tier": "default", "type": "analysis",    "desc": "Remote sensing (satellite imagery, LULC analysis)",
                   "token_profile": "high-input",  "why": "Analyzes large datasets, needs reasoning depth"},
    "hephaestus": {"tier": "default", "type": "advanced",    "desc": "AI pipelines (RAG, LangChain, vector stores)",
                   "token_profile": "high-output", "why": "Complex pipeline code, advanced architecture"},
    "prometheus": {"tier": "default", "type": "advanced",    "desc": "Infrastructure (Docker, CI/CD, deployment)",
                   "token_profile": "medium-output", "why": "Complex configs, multi-stage builds, orchestration"},
    "chiron":     {"tier": "default", "type": "advanced",    "desc": "Model routing, provider configuration, cost optimization",
                   "token_profile": "medium-output", "why": "Needs reasoning for routing decisions, provider analysis"},
    ...
    "hermes":     {"tier": "coding",    "type": "coding",      "desc": "Backend (FastAPI, Python, async, TDD)",
                   "token_profile": "high-output", "why": "Generates lots of code, cost scales with output"},
    "aphrodite":  {"tier": "coding",    "type": "coding",      "desc": "Frontend (React, TypeScript, components)",
                   "token_profile": "high-output", "why": "Generates JSX/TSX, CSS — lots of output tokens"},
    "demeter":    {"tier": "coding",    "type": "coding",      "desc": "Database (SQLAlchemy, Alembic, migrations)",
                   "token_profile": "medium-output", "why": "Moderate code generation, some analysis"},
    "echo":       {"tier": "coding",    "type": "coding",      "desc": "Conversational AI (Rasa NLU, dialogue management)",
                   "token_profile": "medium-output", "why": "Config + some code generation"},

    # TIER 4: FAST — research, discovery, ops, docs, hotfixes
    # Quick responses, simple tasks, many calls
    # → Cheapest model, lowest latency
    "apollo":     {"tier": "fast",    "type": "research",    "desc": "Codebase discovery, parallel research, file search",
                   "token_profile": "many-calls",  "why": "Many parallel searches, each short — cost adds up"},
    "nyx":        {"tier": "fast",    "type": "ops",         "desc": "Observability, tracing, cost tracking, monitoring",
                   "token_profile": "many-calls",  "why": "Frequent monitoring calls, simple summaries"},
    "iris":       {"tier": "fast",    "type": "ops",         "desc": "GitHub operations (branches, PRs, issues, releases)",
                   "token_profile": "many-calls",  "why": "Many git/gh commands, simple formatting"},
    "mnemosyne":  {"tier": "fast",    "type": "docs",        "desc": "Memory bank, documentation, ADRs, progress logging",
                   "token_profile": "medium-output", "why": "Writes docs — moderate output, simple structure"},
    "talos":      {"tier": "fast",    "type": "hotfix",      "desc": "Hotfixes — small bugs, CSS, typos, direct fixes",
                   "token_profile": "low-output",  "why": "Small fixes, minimal output tokens"},
}
...
def main():
    parser = argparse.ArgumentParser(description="Pantheon Model Routing Matrix — Cost-Optimized")
    parser.add_argument("--output", default="model-routing-matrix.md", help="Output path")
