...
> **Formerly known as mythic-agents** — renamed to Pantheon in v3.0.0 to reflect our multi-platform vision.
...
> 📖 **Setup guides:** [OpenCode](platform/opencode/README.md) · [Claude Code](platform/claude/README.md) · [Cursor](platform/cursor/README.md) · [Windsurf](platform/windsurf/README.md)  
> 📖 **Full walkthrough:** [SETUP.md](docs/SETUP.md) — step-by-step from zero to orchestrating  
> 📖 **Platform comparison:** [PLATFORMS.md](docs/PLATFORMS.md) — which platform to pick
...
> 📖 **Step-by-step tutorial**: [SETUP.md](docs/SETUP.md) — from zero to your first orchestration  
> 📖 **Full installation guide**: [INSTALLATION.md](docs/INSTALLATION.md) — all 5 platforms  
> 📖 **Platform comparison**: [PLATFORMS.md](docs/PLATFORMS.md) — which platform to pick  
> 📖 **Releases & versioning**: [RELEASING.md](docs/RELEASING.md)
...
| Platform | README | Install command | Format |
|---|---|---|---|
| **VS Code Copilot** | `agents/` (canonical) | Plugin marketplace or `cp -r` | `.agent.md` |
| **OpenCode** | [opencode/README.md](platform/opencode/README.md) | `node scripts/install.mjs opencode` | `.md` + permission blocks |
| **Claude Code** | [claude/README.md](platform/claude/README.md) | `node scripts/install.mjs claude` | `.md` (comma-tools) |
| **Cursor** | [cursor/README.md](platform/cursor/README.md) | `node scripts/install.mjs cursor` | `.mdc` rules |
| **Windsurf** | [windsurf/README.md](platform/windsurf/README.md) | Coming soon | `.md` (stub) |

All platforms share the same 12 agents, 18 skills, and 9 instruction files. Only the file format changes — auto-generated by `npm run sync`.
...
You need an existing subscription for your AI coding platform (Copilot, Claude Pro, Cursor Pro, or OpenCode). Pantheon itself is free and open-source (MIT).

**Can I use this in editors other than VS Code?**  
**Yes!** Pantheon v3.0+ supports **5 platforms**: VS Code Copilot, OpenCode, Claude Code, Cursor, and Windsurf (preview). Same agents everywhere. See [PLATFORMS.md](docs/PLATFORMS.md).

**How are platform configs generated?**  
Edit `agents/*.agent.md` (the canonical VS Code format), then run `npm run sync`. The sync engine transforms them into every platform's native format. See [RELEASING.md](docs/RELEASING.md).
