...
If the existing agents (Zeus, Athena, Apollo, Hermes, Aphrodite, Maat, Temis, Ra, Mnemosyne, Hephaestus, Gaia, and any you've added) cannot handle a specific domain, you can create a new specialized agent.
