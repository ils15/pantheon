...
handoffs:
    ...
    - { label: "Council Synthesis → Zeus", agent: "zeus", prompt: "Council synthesis complete. Use the recommendation to proceed with orchestration.", send: false, model: premium }
user-invocable: true
---
